...
namespace {
...
#elif Q==64
	extern const int logq[64] = { 0,0,1,6,2,12,7,26,3,32,13,35,8,48,27,18,4,24,
	...
	extern const int expq[63] = { 1,2,4,8,16,32,3,6,12,24,48,35,5,10,20,40,19,
...
#elif Q==128
	extern const int logq[128] = { 0,0,1,31,2,62,32,103,3,7,63,15,33,84,104,
	...
	extern const int expq[127] = { 1,2,4,8,16,32,64,9,18,36,72,25,50,100,65,11,
...
#elif Q==256
	extern const int logq[256] = { 0,0,1,25,2,50,26,198,3,223,51,238,27,104,199,75,4,100,
	...
	extern const int expq[255] = { 1,2,4,8,16,32,64,128,29,58,116,232,205,135,19,38,76,
...
extern int		**row_col;
extern int		**col_row;
extern double	***BETAmn;
extern double	***ALPHAmn;
extern double	**GAMMAn;
extern int		*encoded_sym;
extern double	**GAMMAn_post;
#endif
