...
// **********DISCLAMER*****************
//Since the infomation used is all-zero, the G matrix is irrevelant
// and encoded_sym will result in all-zero vector. For information 
//differetn than zero, the G matrix must be synthesized from the
// Joao Andrade's code.
