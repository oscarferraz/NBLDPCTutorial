...
#if Q==4
    extern unsigned short	h_row_col[1][6];
    extern unsigned short	h_col_row[3][2];
#elif Q==8
    extern unsigned short	h_row_col[1][42];
    extern unsigned short	h_col_row[14][3];
#elif Q==16
    extern unsigned short	h_row_col[3][300];
    extern unsigned short	h_col_row[150][6];
#elif Q==32
    extern unsigned short	h_row_col[3][620];
    extern unsigned short	h_col_row[310][6];
#endif
#endif
